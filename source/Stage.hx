    ...
    public function new(daStage:String)
    {
        ...
        switch(daStage)
        {
			case 'jake-nation':
				{
					camZoom = 0.6;
						curStage = 'jake-nation';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('jake/sky', 'jake'));
						...
						var city:FlxSprite = new FlxSprite(-500, -300).loadGraphic(Paths.image('jake/city', 'jake'));
						...
						var street:FlxSprite = new FlxSprite(-650, 600).loadGraphic(Paths.image('jake/street', 'jake'));
